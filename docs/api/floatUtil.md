...
```JavaScript
floatUtil.add(0.1, 0.2);
// => 0.3

floatUtil.add(2.22, 0.1);
// => 2.32
...
```JavaScript
floatUtil.subtract(1.5, 1.2);
// => 0.3

floatUtil.subtract(0.3, 0.2);
// => 0.1
```
...
```JavaScript
floatUtil.multiply(19.9, 100);
// => 1990

floatUtil.multiply(0.7, 180);
// => 126
```
...
```JavaScript
floatUtil.divide(0.3, 0.1);
// => 3

floatUtil.divide(0.69, 10);
// => 0.069
```
