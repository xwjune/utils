...
describe('日期校验', () => {
  [
    ...
    '2000-02-29', // 400 倍数年，闰
    '2023-02-28', // 平年 2 月
    '2024-01-31', // 31 天月
    '2023-04-30', // 30 天月
    '2024/02/29', // 斜杠分隔
    '0004-02-29', // 0-99 年按真实年份验【4 年为闰年】
    '0000-02-29', // 0 % 400 === 0 亦闰【构造函数回读会按 1900 平年误判】
    '9999-12-31',
  ].forEach((el) => {
    test(el, () => {
      expect(check.date(el)).toBeTruthy();
    });
  });
  [
    '2023-02-29', // 平年 2 月 29 日
    '1900-02-29', // 100 倍数非 400 倍数年，平
    '0050-02-29', // 50 % 4 = 2，平年
    '2024-02-30',
    '2024-04-31', // 30 天月的 31 日
    '2024-13-01', // 13 月
    '2024-00-01', // 0 月
    '2024-01-00', // 0 日
    '24-02-29', // 年不足 4 位
  ...
  test('非字符串【单元素数组隐式转换】', () => {
    ...
    // Symbol 不再抛 TypeError
    expect(check.date(Symbol('s'))).toBeFalsy();
  });
});

describe('常用日期校验【年 1000-9999】', () => {
  [
    '2024-02-29', // 闰年 2 月 29 日
    '2000-02-29', // 400 倍数年，闰
    '1200-02-29', // 边界年 1200 亦 400 倍数，闰
    '2023-02-28', // 平年 2 月
    '2024-01-31', // 31 天月
    '2023-04-30', // 30 天月
    '2024/02/29', // 斜杠分隔
    ...
    test(el, () => {
      expect(check.commonDate(el)).toBeTruthy();
    });
  });
  [
    '2023-02-29', // 平年 2 月 29 日
    '1900-02-29', // 100 倍数非 400 倍数年，平
    '1000-02-29', // 边界年 1000，100 倍数非 400 倍数，平
    '2024-02-30',
    '2024-04-31', // 30 天月的 31 日
    '2024-13-01', // 13 月
    '2024-00-01', // 0 月
    ...
    '2024-02/29', // 分隔符前后不一致
    '2024.02.29', // 点分隔不支持
    '0999-12-31', // 年 1000 前【date 放行、commonDate 不收】
    '0000-02-29', // 全量版独有的 0-99 年区间
  ].forEach((el) => {
    test(el, () => {
  ...
  test('非字符串【单元素数组隐式转换】', () => {
    ...
    expect(check.commonDate(Symbol('s'))).toBeFalsy();
  });
});
